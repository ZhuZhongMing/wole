...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	@Override
	public void sendSysAnnouncement(MessageDTO message, String msg) {
		this.sendSysAnnouncement(message.getToUser(),
				message.getTitle(),
				message.getContent());
	}
...
//			}
	 ...
	 * @param title 标题
	 */
	private void sendSysAnnouncement(String user,String title, String msg) {
		JSONObject obj = new JSONObject();
		obj.put(WebsocketConst.MSG_CMD, WebsocketConst.CMD_USER);
		obj.put(WebsocketConst.MSG_USER_ID, user);
		obj.put(WebsocketConst.MSG_TXT, title);
		obj.put(WebsocketConst.MSG_CONTENT, msg);
