...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //生产设备
        filterChainDefinitionMap.put("/mqtt/mbpDevEquipment/getAll", "anon"); //生产设备全查询
        filterChainDefinitionMap.put("/mqtt/cncModel/queryByEquipmentId", "anon"); //查询最新的指定设备名称的 cnc 数据
        filterChainDefinitionMap.put("/system/mbpMainplanabstract/getByMainplan", "anon"); //查询指定设备计划详情
        filterChainDefinitionMap.put("/mqtt/cncModel/queryAlarmByEId", "anon"); //查询指定设备报警数据
